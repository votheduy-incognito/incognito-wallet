...
import { API_BASE_URL_MAINNET, API_BASE_URL_TESTNET, INCOGNITO_TOKEN_ICON_URL_MAINNET, INCOGNITO_TOKEN_ICON_URL_TESTNET, BEP2_URL, CRYPTO_ICON_URL, DEX_BINANCE_TOKEN_URL, EXPLORER_CONSTANT_CHAIN_URL as TEMPLATE_EXPLORER_CONSTANT_CHAIN_URL, MAINNET_SERVER_ADDRESS, PASSPHRASE_WALLET_DEFAULT, PASSWORD_SECRET_KEY, SHARD_ID, TESTNET_SERVER_ADDRESS, TEST_URL } from 'react-native-dotenv';
...
const BUILD_VERSION = `3.4.1${isMainnet?'':'-'+API_BASE_URL}`;
