...
import { API_BASE_URL_MAINNET, API_BASE_URL_TESTNET, BINANCE_EXPLORER_URL_MAINNET, BINANCE_EXPLORER_URL_TESTNET, CRYPTO_ICON_URL, DEX_BINANCE_TOKEN_URL_MAINNET, DEX_BINANCE_TOKEN_URL_TESTNET, ETHERSCAN_URL_MAINNET, ETHERSCAN_URL_TESTNET, EXPLORER_CONSTANT_CHAIN_URL as TEMPLATE_EXPLORER_CONSTANT_CHAIN_URL, INCOGNITO_TOKEN_ICON_URL_MAINNET, INCOGNITO_TOKEN_ICON_URL_TESTNET, MAINNET_SERVER_ADDRESS, NODE_URL, PASSPHRASE_WALLET_DEFAULT, PASSWORD_SECRET_KEY, SHARD_ID, TESTNET_SERVER_ADDRESS, TEST_URL, USDT_TOKEN_ID_MAINNET, USDT_TOKEN_ID_TESTNET } from 'react-native-dotenv';
...
const BUILD_VERSION = `3.5.0${isMainnet?'':'-'+API_BASE_URL}`;
