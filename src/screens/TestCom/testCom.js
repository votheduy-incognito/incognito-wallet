...
class Kraken extends React.Component {
  ...
  handleImportAccount = async () => {
    ...
    const privateKey =
      '112t8rnYG3kGkuxLeXQUWH3KdQACvCSBEfKxiujwdd31EtCYH2nJfYj3zPRBoAiSPFuhwGnCqCQxcJm5U8XMFqXLtuLy7StCZWpmjorFe7h7';
    const accountName = 'hn1';
    const passPhrase = await getPassphrase();

    let res;
    try {
      res = await Account.importAccount(
        privateKey,
        accountName,
        passPhrase,
        wallet
  ...
  handleImportAccount2 = async () => {
    ...
    const privateKey =
      '112t8rnXSt9kxK7RwGT7QM8Uj9mnSimS4gF2fVK4uZ2dvtnm5Ku1CRX5ruRCAT7iYjL8Pt2yb9PJyYQvDqGVUH5HMqiaSQZWcrRM5ZqYyDKP';
  ...
  handleSendConsant = async () => {
    ...
    const toAddress =
      '1Uv2n3fom66uGuSdMUcicT4GqfZkkCmWF2YvkLCjcj8yiKmnLh4SC1qz2NoFN7TEtyHUqwRADvLAey8gEzPg71EMXcWsMjKyWdBCPmiQy';
    ...
    //estimate fee
    const fromAddress =
      '1Uv3WSbaVLgpUn3zYFtJeYpPVRx6dHAeGCX4gUfh6Qa2Zw9gj9SAv4eyyfQFSmfByLs9k3EYxhTPZjjTfZ4v23xKUrNJvMx5VuHF2iFhQ';
    const privateKey =
      '112t8rnYG3kGkuxLeXQUWH3KdQACvCSBEfKxiujwdd31EtCYH2nJfYj3zPRBoAiSPFuhwGnCqCQxcJm5U8XMFqXLtuLy7StCZWpmjorFe7h7';
    ...
    try {
      const res = await Account.sendConstant(
        param,
        fee,
        isPrivacy,
        account,
  ...
  handleCreateAccount = async () => {
    ...
    try {
      ...
      console.log(
        'Wallet after create new account: ',
  ...
  handleCreateToken = async () => {
    ...
    const fee = await getEstimateFeeForSendingToken(
      fromAddress,
      fromAddress,
      amount,
      tokenObject,
    ...
    try {
      const res = await Token.createSendCustomToken(
        tokenObject,
        fee,
        account,
        wallet
  ...
  handleSendToken = async () => {
    ...
    const tokenObject = {
      Privacy: false,
      TokenID:
        '6d1de0a09da6942429b1565bc971d585a20800e2e8fd1589bfebda5858c105f2',
      TokenName: 'token10',
      TokenSymbol: 'token10',
      TokenTxType: 1,
      TokenAmount: 10000,
  ...
  handleCreatePrivacyToken = async () => {
    ...
    try {
      const res = await Token.createSendPrivacyCustomToken(
        tokenObject,
        fee,
        account,
        wallet
  ...
  handleSendPrivacyToken = async () => {
    ...
    const tokenObject = {
      Privacy: true,
      TokenID:
        '8858208ae02223fd23bc9a02ff9170073335e98320e6586a3ff7b5518d96c256',
      TokenName: 'tp10',
      TokenSymbol: 'tp10',
      TokenTxType: 1,
      TokenAmount: 10000,
  ...
  render() {
    ...
    return (
      <View>
        ...
        <Button
          title="Create new privacy token"
          onPress={this.handleCreatePrivacyToken}
        />
        <Button
          title="Send privacy token"
          onPress={this.handleSendPrivacyToken}
        />
      </View>
    );
  }
