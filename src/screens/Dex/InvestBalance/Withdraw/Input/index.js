...
import withCoinData from '@screens/Dex/InvestBalance/Withdraw/Input/coin.enhance';
...
const TopUp = ({
  ...
  const handleTopUp = () => {
    navigation.navigate(ROUTE_NAMES.InvestWithdrawConfirm, {
      coin,
      value: inputValue,
      text: inputText,
      fee,
  ...
  return (
    <View style={mainStyle.flex}>
      <Header title={`Withdraw ${coin.symbol}`} />
