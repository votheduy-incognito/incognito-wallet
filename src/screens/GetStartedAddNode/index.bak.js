...
import GetQrcode from './components/ScanQRCode/GetQrCode';
...
class GetStartedAddNode extends BaseScreen {
  ...
  renderContent = () => {
    const {currentPage, QRCode, errorMessage, loading} = this.state;
