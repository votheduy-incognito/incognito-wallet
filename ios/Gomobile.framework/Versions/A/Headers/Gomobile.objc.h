// Objective-C API for talking to github.com/incognitochain/incognito-gomobile/gomobile Go package.
//   gobind -lang=objc github.com/incognitochain/incognito-gomobile/gomobile
//
